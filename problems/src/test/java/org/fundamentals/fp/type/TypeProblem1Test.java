...
public class TypeProblem1Test {
    ...
    @Test
    public void given_javaStreamSolution_when_NullPerson_then_returnExpectedResult() {

        //Given
        Assertions.assertThrows(IllegalArgumentException.class, () -> {
            TypeProblem1 problem = new TypeProblem1(null);
        });
    }
    ...
    @Test
    public void given_javaStreamSolution_when_PersonDoesntHaveAnyInsurance_then_returnExpectedResult() {

        //Given
        String DEFAULT_FALLBACK = "Not available";
        BeachHouse house = new BeachHouse(null);
        Person person = new Person(house);
