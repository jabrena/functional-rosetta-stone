...
public class EulerProblem02BenchMarkTest {

    @State(Scope.Benchmark)
    public static class St {
        EulerProblem02 problem = new EulerProblem02();
        Long limit = 4_000_000L;
        static final double AVERAGE_EXPECTED_TIME = 400; // expected max 400 milliseconds
    }
    ...
    private Options initBench() {
        return new OptionsBuilder()
                .include(EulerProblem02BenchMarkTest.class.getSimpleName() + ".*") //
