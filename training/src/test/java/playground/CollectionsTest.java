...
/*
    Java collections are mutable, making them a great source of program failure, especially in the presence of concurrency.
    The Collection interface provides methods such as clear().
    Classes such as ConcurrentHashMap were created to deal with the already created problems.
